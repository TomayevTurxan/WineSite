...
import { FaAngleDown, FaTimes } from "react-icons/fa"; // FaTimes, cancel ikonu için kullanılacak
...
function HamburgerMenu() {
  ...
  return (
    <div className="hamburger-menu">
      {isOpen ? (
        <FaTimes className="icon" onClick={() => setIsOpen(!isOpen)} />
      ) : (
        <GiHamburgerMenu className="icon" onClick={() => setIsOpen(!isOpen)} />
      )}
      <div className={`hamburger-menu-head ${isOpen ? "open" : ""}`}>
        <ul>
          <li onClick={() => toggleMenu(1)}>
            ...
            <FaAngleDown />
            <div className={`accordionMenu ${openIndex === 1 ? "open" : ""}`}>
              {openIndex === 1 && (
                <ul>
                  <h5>
                    <Link
          ...
          <li onClick={() => toggleMenu(2)}>
            ...
            <FaAngleDown />
            <div className={`accordionMenu ${openIndex === 2 ? "open" : ""}`}>
              {openIndex === 2 && (
                <ul>
                  <li>
          ...
          <li onClick={() => toggleMenu(3)}>
            ...
            <FaAngleDown />
            <div className={`accordionMenu ${openIndex === 3 ? "open" : ""}`}>
              {openIndex === 3 && (
                <ul>
                  <li>
                    <Link to="/filterWine">
          ...
          <li onClick={() => toggleMenu(4)}>
            ...
            <FaAngleDown />
            <div className={`accordionMenu ${openIndex === 4 ? "open" : ""}`}>
              {openIndex === 4 && (
                <ul>
                  <li>
                    <Link
